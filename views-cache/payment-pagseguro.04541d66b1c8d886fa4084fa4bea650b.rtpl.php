<?php if(!class_exists('Rain\Tpl')){exit;}?><!-- https://pagseguro.uol.com.br/v2/guia-de-integracao/pagamento-via-html.html -->
...
action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
        ...
        <input name="receiverEmail" type="hidden" value="artur.guitelar@gmail.com">  
        ...
        <input name="senderEmail" type="hidden" value="<?php echo utf8_encode($order["desemail"]); ?>">  
